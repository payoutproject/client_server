...
class Sysparam(models.Model):
    ...
    sysname = models.CharField(max_length=255,verbose_name="系统名称",default="支付系统")
...
class QrType(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    qrtype = models.CharField(max_length=255,verbose_name="类型",default="")
    createtime = models.BigIntegerField(default=0)
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.createtime:
            self.createtime = t
        return super(QrType, self).save(*args, **kwargs)
